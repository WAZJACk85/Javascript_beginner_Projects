(function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function estimateTotal(event) {
      ...
      var totalQty = itemBball + itemJersey + itemPower + itemMineralWater,
        shippingCostPer,
        shippingCost,
        taxFactor = 1,
        estimate,
        totalItemPrice = 90 * itemBball + 25 * itemJersey + 30 * itemPower + 4 * itemMineralWater;

      if (shippingState === "CA") {
        taxFactor = 1.075;
		
	  else if (shippingState === "WS") {
        taxFactor = 1.065;
      }
